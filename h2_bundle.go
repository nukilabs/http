...
//   $ bundle --o=h2_bundle.go --prefix=http2 --tags=!nethttpomithttp2 github.com/nukilabs/http/http2
...
var http2errExtendedConnectNotSupported = errors.New("nukilabs/http: extended connect not supported by peer")
...
func (cs *http2clientStream) encodeAndWriteHeaders(req *Request) error {
	...
	cc.hbuf.Reset()
	res, err := http2encodeRequestHeaders(req, cs.requestedGzip, cc.peerMaxHeaderListSize, cc.t.PseudoHeaderOrder, func(name, value string) {
...
func http2encodeRequestHeaders(req *Request, addGzipHeader bool, peerMaxHeaderListSize uint64, pseudoHeaderOrder []string, headerf func(name, value string)) (httpcommon.EncodeHeadersResult, error) {
